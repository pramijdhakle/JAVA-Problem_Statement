...
import com.lead.exception.ErrorConstants;
...
public class LeadServiceImpl implements LeadService {
    ...
    public LeadSaveResponse createLead(LeadRequest leadRequest) {
        ...
        if (lead.isPresent()) {
            throw new LeadAlreadyExistException(ErrorConstants.LEAD_ALREADY_EXISTS_ERROR_CODE, ErrorConstants.LEAD_ALREADY_EXISTS_ERROR_MESSAGE.get(0));
        } else {
            Lead lead1 = new Lead();
            ...
            try {
                ...
                LeadSaveResponse leadSaveResponse = saveResponse();
    ...
    public LeadFetchResponse fechAllLeads(Long mobileNumber) {
        ...
        if (!CollectionUtils.isEmpty(leadList)) {
            ...
            throw new LeadNotFoundException(ErrorConstants.LEAD_NOT_FOUND_ERROR_CODE, ErrorConstants.LEAD_NOT_FOUND_ERROR_MESSAGE.get(0));        }
